...
cv2.putText(filter2D,'Filtro 2D',(45,320), font, 1, (0,0,255), 2, cv2.LINE_AA)
cv2.putText(blur,'Borrao',(80,320), font, 1, (0,0,255), 2, cv2.LINE_AA)
cv2.putText(gaussianBlur,'BorraoGaussiano',(10,320), font, 1, (0,0,255), 2, cv2.LINE_AA)
cv2.putText(median,'Mediana',(60,320), font, 1, (0,0,255), 2, cv2.LINE_AA)
cv2.putText(bilateralFilter,'Filtro Bilateral',(10,320), font, 1, (0,0,255), 2, cv2.LINE_AA)
